...
class CriticNetwork:
	...
	def create_training_method(self):
		...
		loss = tf.reduce_mean(tf.square(self.y_input - self.q_value_output)) + weight_decay
		self.cost = weight_decay * 100#tf.reduce_mean(tf.square(self.y_input - self.q_value_output))
